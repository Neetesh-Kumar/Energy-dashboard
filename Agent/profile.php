<?php
	...
	$agent_email = "";
	$agent_password = "";
	$query = "select * from agent_data where agent_email = '$_SESSION[agent_email]'";
...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Energy - Agent Dashboard</title>
			...
			<div class="user-info-dropdown my-auto">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-name"><?php echo $agent_name;?></span>
					</a>
            ...
            <div class="card-box pd-20 mb-30">
                <div class="clearfix">
					<div class="row justify-content-between">
						...
						<div class="col-md-4">
							<a href="admin_list.php" class="btn btn-outline-info float-right"><i class="fi-list-thumbnails"></i> Admin List</a>
						</div>
					</div>
                </div>
            </div>
            <div class="pd-20 card-box mb-30 pb-5 ">
                <div class="container text-secondary">
                    <form action="" method="post">
                        <input type="number" name="id" value="<?php echo $a_id;?>" style="display:none" readonly>
                        <legend>Personal Info</legend>
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="agent_name" class="form-control" placeholder="Name" value="<?php echo $agent_name;?>" required>
                                </div>
                            </div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Email Address</label>
									<input type="email" name="agent_email" class="form-control" value="<?php echo $agent_email;?>" required>
								</div>
							</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password" name="agent_password" class="form-control" value="<?php echo $agent_password;?>" required>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <input type="submit" class="btn btn-block btn-outline-info" name="update" value="Update">
                            </div>
                        </div>
                    </form>
                </div>
...
<?php
	if(isset($_POST['update'])){
        include('../connection.php');
        $query = "update agent_data set agent_name='$_POST[agent_name]',agent_email='$_POST[agent_email]',agent_password='$_POST[agent_password]'";
        $query_run = mysqli_query($connection,$query);
         echo "<script>location.href='agent_dashboard.php'</script>";
	}
?>