...
$gas_remarks="";
$gas_file="";
$query = "select * from gas_data  where gas_id = '$_GET[gid]'";
...
<body>
	...
	<div class="main-container">
        ...
        <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            <h4 class="h4">View Gas Submitted Details</h4>
                        </div>
                        <div class="container text-secondary">
                                ...
                                <form action="create_gas.php" class="hidden_div1" method="post" id="hidden_div1">
                                <div class="clearfix">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="gas_file" class="form-control"  value="<?php echo $gas_file;?>">
                                        </div>
                                    </div>
