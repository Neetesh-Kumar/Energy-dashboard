...
$ele_remarks="";
$ele_file="";
$query = "select * from electricity_data  where ele_id = '$_GET[eid]'";
...
<body>
    ...
    <div class="pd-20 card-box mb-30" id="printArea">
                        ...
                        <div class="container text-secondary">
                                <form action="ele_data.php" class="hidden_child" method="post" id="hidden_div">
                                <div class="clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="ele_post_code" class="form-control" value="<?php echo $ele_post_code;?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <a href="../Agent/<?php echo $ele_file;?>" target="blank"> <input type="select" name="ele_file" class="form-control"  value="<?php echo $ele_file;?>" readonly ></a>
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
