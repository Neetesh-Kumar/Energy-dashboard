...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo text-center"><img src="vendors/images/sliderr.png" style="width:60%; height:70px;" class="" alt=""></div>
		...
		<div class="xs-pd-20-10 pd-ltr-20">
			...
			<!-- <div class="card-box mb-30">
				<div class="pd-20">
					<div class="row">
						<div class="col-md-6">
							<h4 class="text-blue h4">Admin Dashboard</h4>
						</div>
						<div class="col-md-6">
						</div>
			...
			<div class="row pt-5">
				<div class="col-lg-12 pt-5 col-md-12 col-sm-12 mb-30">
					<div class="card-box pd-30 pt-10 height-400-p">
						...
						<div class="card-header" style="font-size: 14px;font-weight: 600; color: #111111;">Total Electricity:</div>
						<div class="card-body">
							<p class="card-text">No. of  Electricity: <span class="badge badge-primary"><?php echo get_ele_count(); ?></span></p>
							<a href="ele_data.php" class="btn btn-primary" target="_blank"  type="button">View Electricity Details</a>
							</div>
							</div>
							</div>
							<div class="col-md-6">
							<div class="card bg-white" style="width: 300px">
						<div class="card-header" style="font-size: 14px;font-weight: 600; color: #111111;">Total Gas:</div>
						<div class="card-body">
							<p class="card-text">No. of Gas Details: <span class="badge badge-info"><?php echo get_gas_count(); ?></span></p>
							<a href="gas_data.php" class="btn btn-info" target="_blank"  type="button">View Gas Details</a>
							</div>
							</div>
							</div>
						</div>
