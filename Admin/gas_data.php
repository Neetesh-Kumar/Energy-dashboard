				...
				<table class="table hover data-table-export nowrap table-bordered">
                        ...
                        ?>
                           ...
                           ?>  
								...
								<td>
								<a href="view_gas.php?gid=<?php echo $row['gas_id'];?>" class="text-orange" title="Info"  style="text-decoration: none;"><i class="fa fa-lg fa-info" aria-hidden="true"></i></a>
								<a href="edit_gas_status.php?rid=<?php echo $row['gas_id'];?>" class="text-blue" title="Edit"  style="text-decoration: none;"><i class="fa fa-lg fa-pencil" aria-hidden="true"></i></a>
								<a href="../Agent/<?php echo $row['gas_file'];?>" class="dowload" title="download"  style="text-decoration: none;color: orange;" download><i class="fa fa-lg fa-download" aria-hidden="true"></i></a>  
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								...
								<div class="modal-footer">
									...
									<a href="delete_gas.php?tid=<?php echo $row['gas_id']?>" class="btn btn-danger">Delete</a>
								</div>
								</div>
							</div>
							</div>
