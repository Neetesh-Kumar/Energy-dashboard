<?php
				...
				if(isset($_POST['login'])){
					...
					$query = "select * from agent_data where agent_email = '$_POST[agent_email]'";
					$query_run = mysqli_query($connection,$query);
					while($row = mysqli_fetch_assoc($query_run)){
						if($row['agent_email'] == $_POST['agent_email']){
							if($row['agent_password'] == $_POST['agent_password']){
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            ...
            <h3>Login as <strong>Agent</strong></h3>
             <div class="row">
                    <div class="col-md-6">
                        <a href="index.php" class="btn btn-block btn-outline-warning p-2">
                            Admin
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="" class="btn btn-block btn-warning p-2">
                            Agent
                        </a>
                    </div>
                </div>
            ...
            <form action="#" method="post">
              ...
              <div class="form-group first" style="margin-top:15px;">
                <label for="username">Agent Email</label>
                <input type="agent_email" class="form-control" name="agent_email" placeholder="Enter Agent Email" required>
              </div>
              <div class="form-group last mb-3">
                <label for="password">Password</label>
                <input type="password" class="form-control" name="agent_password" placeholder="Your Password" id="password" required>
              </div>
